...
{
    public partial class patientDocumentByName : Form
    {
        ...
        DateTime xx, y;
        public patientDocumentByName()
        {
            InitializeComponent();
        }
        public patientDocumentByName(string x ,DateTime xx , DateTime y)
        {
            InitializeComponent();
            this.x = x;
            this.xx = xx;
        ...
        private void patientDocumentByName_Load(object sender, EventArgs e)
        {
            string str;
            str = Stream.ReadCS();
