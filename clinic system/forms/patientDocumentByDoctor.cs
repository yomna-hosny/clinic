...
{
    public partial class patientDocumentByDoctor : Form
    {
        ...
        DateTime xx, y;
        public patientDocumentByDoctor()
        {
            InitializeComponent();
        }
        public patientDocumentByDoctor(string x, DateTime xx, DateTime y)
        {
            InitializeComponent();
            this.x = x;
            this.xx = xx;
        ...
        private void patientDocumentByDoctor_Load(object sender, EventArgs e)
        {
            string str;
            str = Stream.ReadCS();
