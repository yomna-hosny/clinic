...
{
    public partial class bookingDocumentationByDoctor : Form
    {
        ...
        DateTime xx, y;
         public bookingDocumentationByDoctor()
        {
            InitializeComponent();
          
        }
         public bookingDocumentationByDoctor(string x, DateTime xx, DateTime y)
        {
            InitializeComponent();
            this.x = x;
            this.xx = xx;
        ...
        private void bookingDocumentationByDoctor_Load(object sender, EventArgs e)
         {
             string str;
            str = Stream.ReadCS();
